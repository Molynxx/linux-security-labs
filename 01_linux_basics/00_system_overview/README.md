...
## Cel 
Zrozumienie podstawowej struktury systemu Linux, czyli co i gdzie się znajduje, jak startuje system, które katalogi są kluczowe dla SOC. 
...
- wykrywanie modyfikacji w newralgicznych katalogach - czy nie ma backdoor, podmiany binariów, podejrzanych plików, itp,
- zrozumienie, gdzie atakujący może wstrzyknąć backdoor - np. boot process, initramfs, GRUB,
