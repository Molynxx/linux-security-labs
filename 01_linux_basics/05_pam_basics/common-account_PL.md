...
- moduł `pam_faillock.so`  i pam_unix.so muszę występować dla poprawnej walidacji kont lokalnych,
...
- flagi modułów powinny być poprawnie ustawione (`required`, `requisite`), by unikać pominięcia istotnych kontroli. 
